...
- AI는 동의 후 학년 정보·과제 문맥·학생의 현재 질문·최근 대화를 외부 제공자에 전달합니다. 반·이름·학교·이메일·비밀번호·세션은 서버 구성 문맥에 포함하지 않습니다. 동의 철회와 대화 기록 삭제를 제공하지만, 외부 제공자 보관·지역·학습 사용 정책은 별도 계약과 설정이 필요합니다.
